...
# Set paths
JOB_DIR="/hpcwork/p0021834/workspace_tianyu/mae_runs/finetune_lr_5e-4"
...
CSV_PATH_VAL="/hpcwork/p0021834/workspace_tianyu/codes/CMIL/csvs/dataset_multi_abnormality_labels_test_set.csv"
