...
def process_image(row_dict, save_path, new_shape=(384, 512, 512)):
    ...
    try:
        ...
        file_path = os.path.join('/mnt/nas/CT/RSNA_RESPECT', row['VolumeName'])
...
if __name__ == '__main__':
    # Example usage
    annotations_file = '/home/than/DeepLearning/CMIL/csvs/RSNA_2020_metadata.csv'  # CSV file with image-text annotations
    os.makedirs('/mnt/nas/CT/npz_npy_RESPECT', exist_ok=True)
    output_path = '/mnt/nas/CT/npz_npy_RESPECT'  # Output path for the NIfTI dataset
