...
PRETRAIN_CHKPT="/home/than/DeepLearning/CMIL/notebooks/"  # Path to pre-trained checkpoint


# Run the script
CUDA_VISIBLE_DEVICES=0,1,2 torchrun --nproc_per_node=3 finetune_fmcib.py \
    --batch_size 1 \
    --accum_iter 64 \
